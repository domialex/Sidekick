...
namespace Sidekick.Infrastructure.PoeNinja
{
    public class GetPriceFromNinjaHandler : IQueryHandler<GetPriceFromNinjaQuery, NinjaPrice>
    {
        ...
        {
            var cacheResult = await repository.Find(request.Item.Texts.NameLine, request.Item.Corrupted, request.Item.Properties.MapTier, request.Item.Properties.GemLevel);
            ...
            cacheResult = await repository.Find(request.Item.Texts.NameLine, request.Item.Corrupted, request.Item.Properties.MapTier, request.Item.Properties.GemLevel);
            return cacheResult;
        }
