namespace Sidekick.Presentation.Blazor.Settings
{
    public class SettingsResources
    {
        ...
        public const string Chat_Key_Exit = "Chat_Key_Exit";
        public const string Chat_Key_Hideout = "Chat_Key_Hideout";
        public const string Chat_Key_LeaveParty = "Chat_Key_LeaveParty";
        public const string Chat_Key_ReplyToLastWhisper = "Chat_Key_ReplyToLastWhisper";
